...
```{r category import}
genedata <- read.table("/Users/BarbaraMaria/Dropbox/projects/2016_dsx-phase2/data/Otau-genedata/Otau_combineddata.tsv", sep="\t",header=TRUE)
```

## Ideas and to-do
Cluster count table so that gene clusters behaving in the same way could be isolated.
